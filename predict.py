...
SDXL_VERSION="diffusers/stable-diffusion-xl-1.0-inpainting-0.1"
    ...
    def load_trained_weights(self, weights, pipe):
        ...
        if not self.is_lora:
            ...
            if False:
                ...
                # load text
                # TEMP FOR OTHER FORMAT DONT PUSH 
                ...
                pipe.load_lora_weights(tensor)

                
                text_encoders = [pipe.text_encoder, pipe.text_encoder_2]
                tokenizers = [pipe.tokenizer, pipe.tokenizer_2]
                state_dict = load_file(os.path.join(local_weights_cache, "embeddings.safetensors"))
