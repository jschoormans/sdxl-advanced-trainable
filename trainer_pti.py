...
def main(
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            (tok1, tok2), vae_latent, mask, random_mask_latents, masked_image_latents = batch
            ...
            # add random noise to the input (2nd dim from 4 to 9)
            # shape is [1, 4, 64, 64] it should be [1, 9, 64, 64]
